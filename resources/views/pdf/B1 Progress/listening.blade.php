...
@section('main')
    ...
    <section>
        ...
        <main>
            ...
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B1_Progress:L2'][1]) !!}</mark></p>

            <p style="padding: 0 4rem; color: #000;"><b>b.</b> What are Martha’s solutions?</p>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B1_Progress:L2'][2]) !!}</mark></p>

            <p style="padding: 0 4rem; color: #000;"><b>c.</b> Who wins the discussion? Explain your answer</p>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B1_Progress:L2'][3]) !!}</mark></p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B1_Progress:L3'][1]) !!}</mark></p>
        </main>
    </section>
@endsection