...
@section('main')
    ...
    <section>
        ...
        <main>
            ...
            <p style="color: #0091B7; padding: 0 4rem;">
                @if (isset($answers['Forward:L1'][1]) && $answers['Forward:L1'][1] == '...believes he should be respectful with his ex-teacher at all times')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][1]) && $answers['Forward:L1'][1] == '...finds it easy to be on casual terms with his ex-teacher')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][1]) && $answers['Forward:L1'][1] == '...feels uneasy about referring to his ex-teacher by her first name')
            ...
            <p style="color: #0091B7; padding: 0 4rem;">
                @if (isset($answers['Forward:L1'][2]) && $answers['Forward:L1'][2] == '...has two daughters from a previous marriage')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][2]) && $answers['Forward:L1'][2] == '...has two daughters from his current marriage')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][2]) && $answers['Forward:L1'][2] == '...has one daughter from a previous marriage, and one from his current marriage')
            ...
            <p style="color: #0091B7; padding: 0 4rem;">
                @if (isset($answers['Forward:L1'][3]) && $answers['Forward:L1'][3] == '...is fully up to date with information technology')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][3]) && $answers['Forward:L1'][3] == '...prefers traditional technologies')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][3]) && $answers['Forward:L1'][3] == '...uses a tablet with an electronic pen')
            ...
            <p style="color: #0091B7; padding: 0 4rem;">
                @if (isset($answers['Forward:L1'][4]) && $answers['Forward:L1'][4] == '...thought the food in Mexico was awful')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][4]) && $answers['Forward:L1'][4] == '...thought the food in Mexico could kill you')
                ...
                @endif
                <br />
                @if (isset($answers['Forward:L1'][4]) && $answers['Forward:L1'][4] == '...thought the food in Mexico was delicious')
    ...
    <section>
        ...
        <main>
            ...
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['Forward:L2'][5]) !!}</mark></p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            ...
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['Forward:L3'][1]) !!}</mark></p>
            ...
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['Forward:L3'][2]) !!}</mark></p>
        </main>
    </section>
@endsection