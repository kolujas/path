...
@section('main')
    ...
    <section>
        ...
        <main>
            ...
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['A2_Elementary:RW1'][1]) !!}</mark></p>

            <p style="padding: 0 4rem; color: #000;"><b>b.</b> What do you think of the judge’s decision?</p>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['A2_Elementary:RW1'][2]) !!}</mark></p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;"><b>a.</b> If I take this bag to my father, <mark>{{ $answers['A2_Elementary:RW2'][1] }}</mark>.</p>
            <p style="padding: 0 4rem; color: #000;"><b>b.</b> If <mark>{{ $answers['A2_Elementary:RW2'][2] }}</mark>, someone else will find the bag.</p>
            <p style="padding: 0 4rem; color: #000;"><b>c.</b> If <mark>{{ $answers['A2_Elementary:RW2'][3] }}</mark>.</p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;"><b>a.</b> Public transport <mark>{{ $answers['A2_Elementary:RW3'][1] }}</mark>.</p>
            <p style="padding: 0 4rem; color: #000;"><b>b.</b> Road traffic <mark>{{ $answers['A2_Elementary:RW3'][2] }}</mark>, someone else will find the bag.</p>
            <p style="padding: 0 4rem; color: #000;"><b>c.</b> (Your choice) <mark>{{ $answers['A2_Elementary:RW3'][3] }}</mark>.</p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['A2_Elementary:RW4'][1]) !!}</mark></p>
        </main>
    </section>
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['A2_Elementary:RW5'][1]) !!}</mark></p>
        </main>
    </section>
@endsection