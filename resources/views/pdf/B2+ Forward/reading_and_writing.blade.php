...
<section>
    ...
    <main>
        ...
        <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW1'][1] }}</mark></p>
        ...
        <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW1'][2] }}</mark></p>
        ...
        <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW1'][3] }}</mark></p>
    </main>
</section>
...
<section>
    ...
    <main>
        @if (isset($answers['B2_Forward:RW2']) && isset($answers['B2_Forward:RW2'][1]))
            <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW2'][1] }}</mark></p>
        @else
            <p style="padding: 0 4rem; color: #000;"><mark>null</mark></p>
        @endif
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW2'][2]) !!}</mark></p>
    </main>
</section>
...
<section>
    ...
    <main>
        @if (isset($answers['B2_Forward:RW3']) && isset($answers['B2_Forward:RW3']['1a']))
            <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW3']['1a'] }}</mark></p>
        @else
            <p style="padding: 0 4rem; color: #000;"><mark>null</mark></p>
        @endif
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW3']['1b']) !!}</mark></p>
    </main>
    <main>
        @if (isset($answers['B2_Forward:RW3']) && isset($answers['B2_Forward:RW3']['2a']))
            <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW3']['2a'] }}</mark></p>
        @else
            <p style="padding: 0 4rem; color: #000;"><mark>null</mark></p>
        @endif
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW3']['2b']) !!}</mark></p>
    </main>
    <main>
        @if (isset($answers['B2_Forward:RW3']) && isset($answers['B2_Forward:RW3']['3a']))
            <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW3']['3a'] }}</mark></p>
        @else
            <p style="padding: 0 4rem; color: #000;"><mark>null</mark></p>
        @endif
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW3']['3b']) !!}</mark></p>
    </main>
</section>
...
<section>
    ...
    <main>
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW4'][1]) !!}</mark></p>
    </main>
</section>
...
<section>
    ...
    <main>
        @if (isset($answers['B2_Forward:RW5']) && isset($answers['B2_Forward:RW5'][1]))
            <p style="padding: 0 4rem; color: #000;"><mark>{{ $answers['B2_Forward:RW5'][1] }}</mark></p>
        @else
            <p style="padding: 0 4rem; color: #000;"><mark>null</mark></p>
        @endif
        <p style="padding: 0 4rem; color: #000;"><mark>{!! nl2br($answers['B2_Forward:RW5'][2]) !!}</mark></p>
    </main>
</section>