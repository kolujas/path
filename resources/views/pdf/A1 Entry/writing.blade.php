...
@section('main')
    ...
    <section>
        ...
        <main>
            <p style="padding: 0 4rem; color: #000;">Hello! I am Ivan. My friend's name <mark>{{ $answers['A1_Entry:W4'][1] }}</mark> Julie. I <mark>{{ $answers['A1_Entry:W4'][2] }}</mark> a boy. She <mark>{{ $answers['A1_Entry:W4'][3] }}</mark> a girl. We <mark>{{ $answers['A1_Entry:W4'][4] }}</mark> childrens</p>
        </main>
    </section>
