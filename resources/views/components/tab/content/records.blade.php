<section id="records" class="tab-content closed">
    <main class="row relative">
        <header class="content-header col-12 mx-md-4 mx-lg-0">
            <h2 class="text-uppercase text-left mt-4 mb-3 px-2 px-md-0">Records</h2>
            <div class="pointer-events mx-0 mb-3 px-2 px-md-0 d-flex align-items-center">
                <p class="filter-title mb-0 mr-3">Order by:</p>
                <button type="button" data-by="exam:scheduled_date_time" data-type="ASC" class="filter-records filter-order btn btn-two mr-3">
            ...
            <div class="pointer-events mb-4 px-2 px-md-0">
                <div class="search-bar">
                    ...
                    <input id="search" data-name="records-search" class="filter filter-search input-search" placeholder="Type to search..." type="search">
                </div>
            </div>
        </header>
