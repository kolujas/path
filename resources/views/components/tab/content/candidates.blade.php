    ...
    <main class="row relative">
        <header class="content-header col-12 mx-md-4 mx-lg-0">
            ...
            <div class="pointer-events mx-0 mb-3 px-2 px-md-0 d-flex align-items-center">
                <p class="filter-title mb-0 mr-3">Filter by:</p>
                <button type="button" class="filter-button btn btn-two mr-3">Fecha</button>
                <button type="button" class="filter-button btn btn-two">Nombre [A-Z]</button>
            </div>
