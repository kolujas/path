<section id="dropdown-demo-question-1" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
        ...
        <div class="row justify-content-md-between justify-content-lg-center py-4">
            ...
            <div class="col-12 col-md-6 col-lg-2 mb-4 mb-lg-0 card-min-width">
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <select clas="input-long" name="DEMO:RW1[1]">
            ...
            <div class="col-12 col-md-6 col-lg-2 mb-4 mb-lg-0 card-min-width">
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <select clas="input-long" name="DEMO:RW1[2]">
                            <option disabled selected>Bedroom</option>
                            <option>Garden</option>
                            <option>Kitchen</option>
                            <option>Lounge</option>
            ...
            <div class="col-12 col-md-6 col-lg-2 mb-4 mb-lg-0 card-min-width">
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <select clas="input-long" name="DEMO:RW1[3]">
                            <option disabled selected>Bedroom</option>
                            <option>Garden</option>
                            <option>Kitchen</option>
                            <option>Lounge</option>
            ...
            <div class="col-12 col-md-6 col-lg-2 card-min-width">
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <select clas="input-long" name="DEMO:RW1[4]">
                            <option disabled selected>Bedroom</option>
                            <option>Garden</option>
                            <option>Kitchen</option>
                            <option>Lounge</option>
