<section id="dropdown-competency-writing-3" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    ...
    <main class="dropdown-menu-content three-question-container px-xl-4">
        <div class="info mx-auto mb-4">
            <ul>
                <li>Interviewer: Congratulations on winning the championship Teddy! </li>
                <li>Teddy: Thanks! It’s a great feeling!</li>
                <li>Interviewer: Are you going to retire now?</li>
                <li>Teddy: Definitely not! I’m looking forward to next year already. </li>
                <li>Interviewer: Do you think you can win again?</li>
                <li>Teddy: Why not? I have a great team and lots of support.</li>
                <li>Interviewer: Are you sure you will drive for the same team?</li>
