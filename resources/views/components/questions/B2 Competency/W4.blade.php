<section id="dropdown-writing-4" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    ...
    <main class="dropdown-menu-content four-question-container px-xl-4">
        <div class="info mx-auto mb-4">
            <ul>
                <li>a. The estimated number of attendees.</li>
                <li>b. The possibilities for asking questions.</li>
                <li>c. The availability of a recording of the webinar after the event.</li>
        </ul>
        </div>

        <div class="py-4">
            <div class="pl-5 text-left b3-ex4-p">
                <p class="h5 mb-4">Thank the sender, and use an appropriate salutation and ending.</p>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                ...
                <textarea class="B2-email-textarea" name="B1_Progress:W4[1]" class="pl-2"></textarea>
            </div>
        </div>
    </main>
</section>