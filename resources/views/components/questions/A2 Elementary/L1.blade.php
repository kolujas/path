<section id="dropdown-elementary-listening-1" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    <a href="#" class="dropdown-header">
        <span>1. Listen to a conversation between a <b>man</b> and a <b>woman</b>, then tick the correct boxes.</span>
    ...
    <main class="dropdown-menu-content one-question-container px-xl-4">
        <div class="d-flex justify-content-center my-4">
            <audio class="d-none" controls controlsList="nodownload">
                <source
                    src="{{asset('audios/Elementary-1.mp3')}}" type="audio/mpeg">
        ...
        <table class="table table-normal table-striped mb-4 mx-auto">
            <thead>
                <tr>
                    <th scope="col">Who...</th>
                    <th scope="col" class="text-center">Man</th>
                    <th scope="col" class="text-center">Woman</th>
                    <th scope="col" class="text-center">Both</th>
                </tr>
            </thead>
            <tbody>
                <tr>
