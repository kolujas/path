    ...
    <main class="dropdown-menu-content two-question-container px-xl-4">
        <div class="d-flex justify-content-center my-4">
            <audio class="d-none" controls controlsList="nodownload">
                <source
                    src="{{asset('audios/Forward-2.mov')}}" type="audio/mpeg">
        ...
        <div class="py-4">
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                ...
                <textarea id="B2-indent-1" name="B2_Forward:L2[1]" class="px-2 text"></textarea>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <label for="B2-indent-2" class="indent">What are the main objections to the assistance offered? (b)</label>
                <textarea id="B2-indent-2" name="B2_Forward:L2[2]" class="px-2 last text"></textarea>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <label for="B2-indent-3" class="indent">In what ways is sarcasm used? (c)</label>
                <textarea id="B2-indent-3" name="B2_Forward:L2[3]" class="px-2 last text"></textarea>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                ...
                <textarea id="B2-indent-4" name="B2_Forward:L2[4]" class="px-2 last text"></textarea>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <label for="B2-indent-5" class="indent">What points does the politician make about the ‘globalised economy’? (e)</label>
                <textarea id="B2-indent-5" name="B2_Forward:L2[5]" class="pl-2 last text"></textarea>
            </div>
        </div> 
    </main>
</section>