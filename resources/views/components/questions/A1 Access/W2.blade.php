<section id="dropdown-writing-2" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    ...
    <main class="dropdown-menu-content two-question-container px-xl-4">
        ...
        <div class="row justify-content-md-between justify-content-lg-center pt-4">
            <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0 card-min-width">
                <div class="card">
            ...
            <div class="col-12 col-md-6 col-lg-4 card-min-width">
                <div class="card">
            ...
            <div class="col-12 col-md-6 col-lg-4 card-min-width">
                <div class="card">
                    <img src="{{ asset('img/recursos/hector.jpg') }}" class="img-fluid" alt="image-six-question-one">
                    <div class="card-body mx-auto text-center">
                        f
                    </div>
                </div>
