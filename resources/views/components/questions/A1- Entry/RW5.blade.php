<section id="dropdown-entry-writing-5" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    ...
    <main class="dropdown-menu-content fifth-question-container px-xl-4">
        <div class="py-4">
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <textarea name="A1_Entry:RW5[1]" class="px-2 text"></textarea>
            </div>
        </div>
    </main>
</section>