...
<div id="monkey-cont" class="animal-cont">
	<div>
        <p>m</p>
		<input name="A1_Entry:RW3[1]" maxlength="1" type="text">
		<p>n</p>
		<p>k</p>
		<input name="A1_Entry:RW3[2]" maxlength="1" type="text">
		<p>y</p>
	</div>
</div>
...
<div id="tiger-cont" class="animal-cont">
	<div>
        <p>t</p>
		<input name="A1_Entry:RW3[3]" maxlength="1" type="text">
		<p>g</p>
		<input name="A1_Entry:RW3[4]" maxlength="1" type="text">
		<p>r</p>
	</div>
</div>
...
<div id="bird-cont" class="animal-cont">
	<div>
        <p>b</p>
		<input name="A1_Entry:RW3[5]" maxlength="1" type="text">
		<input name="A1_Entry:RW3[6]" maxlength="1" type="text">
        <p>d</p>
	</div>
</div>
...
<div id="pet-cont" class="animal-cont">
	<div>
		<p>p</p>
		<input name="A1_Entry:RW3[7]" maxlength="1" type="text">
		<p>t</p>
	</div>
</div>
