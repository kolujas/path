    ...
    <main class="dropdown-menu-content three-question-container px-xl-4">
        <div class="info mx-auto mb-4">
            <ul>
                ...
                <li>Man: I can get it by tomorrow. Where are the photos? </li>
                <li>Woman: They’re in a safe place. Don’t worry.</li>
            </ul>
        </div>
        ...
        <div class="complete col-12 col-lg-10 col-xl-8 mx-auto my-4 position-relative">
            ...
            <textarea id="identeado-police" name="B1_Progress:RW3[1]"class="px-2 text"></textarea>
        </div>        
    </main>
</section>