<section id="dropdown-achiever-writing-4" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    ...
    <main class="dropdown-menu-content four-question-container px-xl-4">
        <div class="row justify-content-md-between justify-content-lg-center py-4">
            ...
            <div class="card col-12 col-md-6 col-lg-2 mb-4 mb-lg-0">
                ...
                <div class="card-body mx-auto">
                    <select name="A1_Achiever:RW4A[1]">
            ...
            <div class="card col-12 col-md-6 col-lg-2 mb-4 mb-lg-0">
                ...
                <div class="card-body mx-auto">
                    <select name="A1_Achiever:RW4A[2]">
                        <option disabled selected>Sunny</option>
                        <option>Cloudy</option>
                        <option>Windy</option>
                        <option>Misty</option>
            ...
            <div class="card col-12 col-md-6 col-lg-2 mb-4 mb-lg-0">
                ...
                <div class="card-body mx-auto">
                    <select name="A1_Achiever:RW4A[3]">
                        <option disabled selected>Sunny</option>
                        <option>Cloudy</option>
                        <option>Windy</option>
                        <option>Misty</option>
        ...
        <div class="py-4">
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                ...
                <textarea name="A1_Achiever:RW4B[1]" class="px-2 text"></textarea>
            </div>
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <span class="indent">...do you like doing on sunny days?</span>
                <textarea name="A1_Achiever:RW4B[2]" class="px-2 last text"></textarea>
            </div>
        </div> 
    </main>
</section>