<section id="dropdown-writing-5" class="question dropdown dropdown-click closed col-12 col-lg-10 col-xl-8 mb-4">
    <a href="#" class="dropdown-header">
        <span>5. Write about the most exciting place you have visited. Include information about it, why you liked it, and the activities you did.</span>
    ...
    <main class="dropdown-menu-content five-question-container px-xl-4">
        <div class="py-4">
            <div class="complete col-12 col-lg-10 col-xl-8 mx-auto position-relative">
                <textarea name="A2_Elementary:RW5[1]" class="px-2 text"></textarea>
            </div>
        </div>
    </main>
</section>